package com.wangxingxing.wxxnovacompose.feature.projectcategory.ui
...
import com.wangxingxing.wxxnovacompose.feature.projectcategory.data.repository.ProjectCategoryRepository
                    ...
                    when (result) {
                        ...
                        is ApiResult.Error -> {
                            ...
                            updateUiState(UiState.Error(
                                R.string.error_unknown.getString()))
                        }
                    }
                }
                ...
                repository.getProjectCategories()
                    .catch { e ->
                        if (uiState.value !is UiState.Error) {
                            updateUiState(UiState.Error(e.message ?: R.string.error_unknown.getString()))
                        }
                    }
                    .collect { data ->
